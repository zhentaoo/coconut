!function (e) {
    ...
    return function (e, t, n) {
        ...
        1: [function (e, t) {
            ...
            var o = e("webrtc"), i = e("wildemitter"), r = e("webrtcsupport"), s = e("attachmediastream"), a = e("mockconsole"), c = e("socket.io-client");
            n.prototype = Object.create(i.prototype, {constructor: {value: n}}), n.prototype.leaveRoom = function () {
                ...
                this.webrtc.startLocalMedia(this.config.media, function (t, n) {
                    t ? e.emit("localMediaError", t) : s(n, e.getLocalVideoContainer(), {muted: !0, mirror: !0})
                })
        ...
        }, {attachmediastream: 5, mockconsole: 7, "socket.io-client": 6, webrtc: 3, webrtcsupport: 4, wildemitter: 2}],
        2: [function (e, t) {
            function n() {
                this.callbacks = {}
            }
            ...
            t.exports = n, n.prototype.on = function (e) {
                ...
                var t, n, o, i = [].slice.call(arguments, 1), r = this.callbacks[e], s = this.getWildcardCallbacks(e);
                if (r)for (o = r.slice(), t = 0, n = o.length; n > t && o[t]; ++t)o[t].apply(this, i);
                if (s)for (n = s.length, o = s.slice(), t = 0, n = o.length; n > t && o[t]; ++t)o[t].apply(this, [e].concat(i));
                return this
        ...
        5: [function (e, t) {
            t.exports = function (e, t, n) {
                ...
                if (r.autoplay && (s.autoplay = "autoplay"), r.muted && (s.muted = !0), r.mirror && ["", "moz", "webkit", "o", "ms"].forEach(function (e) {
                        ...
                        s.style[t] = "scaleX(-1)"
                    }), i && i.createObjectURL)s.src = i.createObjectURL(e); else if (s.srcObject)s.srcObject = e; else {
            ...
            !function () {
                if (function (e, t) {
                        ...
                        n.load = function (e) {
                            ...
                            var r, s = i || [], a = "undefined" == typeof o ? 2 : o;
                        ...
                        function str(e, t) {
                            ...
                            switch (c instanceof Date && (c = date(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
                                ...
                                case"object":
                                    ...
                                    if (rep && "object" == typeof rep)for (r = rep.length, n = 0; r > n; n += 1)"string" == typeof rep[n] && (o = rep[n], i = str(o, c), i && s.push(quote(o) + (gap ? ": " : ":") + i)); else for (o in c)Object.prototype.hasOwnProperty.call(c, o) && (i = str(o, c), i && s.push(quote(o) + (gap ? ": " : ":") + i));
                                    return i = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, i
                            }
                        }
                        ...
                        var n = e.parser = {}, o = n.packets = ["disconnect", "connect", "heartbeat", "message", "json", "event", "ack", "error", "noop"], i = n.reasons = ["transport not supported", "client not handshaken", "unauthorized"], r = n.advice = ["reconnect"], s = t.JSON, a = t.util.indexOf;
                        n.encodePacket = function (e) {
                            var t = a(o, e.type), n = e.id || "", c = e.endpoint || "", u = e.ack, p = null;
                            switch (e.type) {
                                case"error":
                                    var l = e.reason ? a(i, e.reason) : "", h = e.advice ? a(r, e.advice) : "";
                                    ("" !== l || "" !== h) && (p = l + ("" !== h ? "+" + h : ""));
                                    break;
                                case"message":
                                    "" !== e.data && (p = e.data);
                        ...
                        e.Socket = o, t.util.mixin(o, t.EventEmitter), o.prototype.of = function (e) {
                            ...
                            var o = this, r = this.options, s = ["http" + (r.secure ? "s" : "") + ":/", r.host + ":" + r.port, r.resource, t.protocol, t.util.query(this.options.query, "t=" + +new Date)].join("/");
                    ...
                    function n(e) {
                        if (typeof P.addEventListener != O)P.addEventListener("load", e, !1); else if (typeof L.addEventListener != O)L.addEventListener("load", e, !1); else if (typeof P.attachEvent != O)g(P, "onload", e); else if ("function" == typeof P.onload) {
                            var t = P.onload;
                            P.onload = function () {
                                t(), e()
                            }
                    ...
                    function i() {
                        var e = L.getElementsByTagName("body")[0], t = y(j);
                    ...
                    function r() {
                        ...
                        if (e > 0)for (var t = 0; e > t; t++) {
                            var n = $[t].id, o = $[t].callbackFn, i = {success: !1, id: n};
                            if (J.pv[0] > 0) {
                                var r = m(n);
                                if (r)if (!v($[t].swfVersion) || J.wk && J.wk < 312)if ($[t].expressInstall && a()) {
                                    ...
                                    c(p, l, n, o)
                                } else u(r), o && o(i); else w(n, !0), o && (i.success = !0, i.ref = s(n), o(i))
                            } else if (w(n, !0), o) {
                                var y = s(n);
                    ...
                    function c(e, t, n, o) {
                        ...
                        if (i) {
                            ...
                            var r = J.ie && J.win ? ["Active"].concat("").join("X") : "PlugIn", s = "MMredirectURL=" + P.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + r + "&MMdoctitle=" + L.title;
                    ...
                    var S, T, C, x, E, _, O = "undefined", j = "object", A = "Shockwave Flash", D = "ShockwaveFlash.ShockwaveFlash", R = "application/x-shockwave-flash", N = "SWFObjectExprInst", I = "onreadystatechange", P = window, L = document, M = navigator, W = !1, q = [o], $ = [], F = [], B = [], X = !1, H = !1, U = !0, J = function () {
                        var e = typeof L.getElementById != O && typeof L.getElementsByTagName != O && typeof L.createElement != O, t = M.userAgent.toLowerCase(), n = M.platform.toLowerCase(), o = n ? /win/.test(n) : /win/.test(t), i = n ? /mac/.test(n) : /mac/.test(t), r = /webkit/.test(t) ? parseFloat(t.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, s = !1, a = [0, 0, 0], c = null;
                        if (typeof M.plugins != O && typeof M.plugins[A] == j)c = M.plugins[A].description, !c || typeof M.mimeTypes != O && M.mimeTypes[R] && !M.mimeTypes[R].enabledPlugin || (W = !0, s = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0); else if (typeof P[["Active"].concat("Object").join("X")] != O)try {
                        ...
                        return {w3: e, pv: a, wk: r, ie: s, win: o, mac: i}
                    }();
                    return function () {
                        ...
                        registerObject: function (e, t, n, o) {
                            ...
                            var d = {success: !1, id: n};
                            J.w3 && !(J.wk && J.wk < 312) && e && n && o && i && r ? (w(n, !1), t(function () {
                                o += "", i += "";
                                var t = {};
                                if (h && typeof h === j)for (var m in h)t[m] = h[m];
                            ...
                            if (t) {
                                ...
                                for (var n = t.split("&"), o = 0; o < n.length; o++)if (n[o].substring(0, n[o].indexOf("=")) == e)return k(n[o].substring(n[o].indexOf("=") + 1))
                            }
                            return ""
                ...
                !function () {
                    ...
                    e.XHR = o, t.util.inherit(o, t.Transport), o.prototype.open = function () {
                        ...
                        try {
                            var i = t.util.request(o), r = n.XDomainRequest && i instanceof XDomainRequest, s = e && e.options && e.options.secure ? "https:" : "http:", a = n.location && s != n.location.protocol;
                            if (i && (!r || !a))return !0
                        } catch (c) {
                        }
                        return !1
        ...
        8: [function (e, t, n) {
            ...
            e("events"), n.isArray = o, n.isDate = function (e) {
                ...
                function p(e, c) {
                    ...
                    l.pop();
                    var k = 0, S = w.reduce(function (e, t) {
                        return k++, t.indexOf("\n") >= 0 && k++, e + t.length + 1
                    }, 0);
        ...
        10: [function (e, t) {
            var n, o = !1, i = !1, r = navigator.userAgent.toLowerCase();
            -1 !== r.indexOf("firefox") ? (n = "moz", i = !0) : -1 !== r.indexOf("chrome") && (n = "webkit", o = !0);
        ...
        3: [function (e, t) {
            ...
            e("wildemitter");
            var r = e("mockconsole"), s = e("localmedia"), a = e("./peer");
        ...
        }, {"./peer": 11, localmedia: 12, mockconsole: 7, util: 8, webrtcsupport: 10, wildemitter: 2}],
        13: [function (e, t) {
            var n = t.exports = {};
            n.nextTick = function () {
        ...
        9: [function (e, t, n) {
            ...
            var r = n.EventEmitter = i.EventEmitter, s = "function" == typeof Array.isArray ? Array.isArray : function (e) {
                return "[object Array]" === Object.prototype.toString.call(e)
            }, a = 10;
        ...
        11: [function (e, t) {
            ...
            var o = e("util"), i = e("webrtcsupport"), r = e("rtcpeerconnection"), s = e("wildemitter");
        ...
        }, {rtcpeerconnection: 14, util: 8, webrtcsupport: 10, wildemitter: 2}],
        15: [function (e, t) {
            ...
            t.exports = function (e, t) {
                var o, i = 2 === arguments.length, r = {
                    video: !0,
                    audio: !0
                }, s = "PERMISSION_DENIED", a = "CONSTRAINT_NOT_SATISFIED";
        ...
        12: [function (e, t) {
            ...
            var o = e("util"), i = e("hark"), r = e("webrtcsupport"), s = e("getusermedia"), a = e("getscreenmedia"), c = e("wildemitter"), u = e("mediastream-gain"), p = e("mockconsole");
        ...
        19: [function (e, t, n) {
            !function () {
                var e = this, o = e._, i = {}, r = Array.prototype, s = Object.prototype, a = Function.prototype, c = r.push, u = r.slice, p = r.concat, l = s.toString, h = s.hasOwnProperty, f = r.forEach, d = r.map, m = r.reduce, y = r.reduceRight, g = r.filter, v = r.every, b = r.some, w = r.indexOf, k = r.lastIndexOf, S = Array.isArray, T = Object.keys, C = a.bind, x = function (e) {
                ...
                x.contains = x.include = function (e, t) {
                    ...
                    var n = u.call(arguments, 2), o = x.isFunction(t);
                ...
                x.sortBy = function (e, t, n) {
                    return t = j(t), x.pluck(x.map(e, function (e, o, i) {
                        return {value: e, index: o, criteria: t.call(n, e, o, i)}
                    }).sort(function (e, t) {
                ...
                var N = function (e, t, n, o) {
                    ...
                    var c = 0, u = !0;
                    if ("[object Array]" == i) {
                        if (c = e.length, u = c == t.length)for (; c-- && (u = N(e[c], t[c], n, o)););
                    } else {
                        for (var p in e)if (x.has(e, p) && (c++, !(u = x.has(t, p) && N(e[p], t[p], n, o))))break;
                        if (u) {
                ...
                x.template = function (e, t, n) {
                    ...
                    var i = new RegExp([(n.escape || M).source, (n.interpolate || M).source, (n.evaluate || M).source].join("|") + "|$", "g"), r = 0, s = "__p+='";
        ...
        14: [function (e, t) {
            ...
            var o = e("underscore"), i = e("util"), r = e("webrtcsupport"), s = e("sdp-jingle-json"), a = e("wildemitter"), c = e("traceablepeerconnection");
            i.inherits(n, a), Object.defineProperty(n.prototype, "signalingState", {
                ...
                var n = this;
                if (e.contents) {
                    var i = o.pluck(this.remoteDescription.contents, "name"), a = e.contents;
                    a.forEach(function (e) {
                        var t = e.transport || {}, o = t.candidates || [], a = i.indexOf(e.name), c = e.name;
                ...
                var t = this;
                if (e.candidate) {
                    var n = e.candidate, i = {candidate: e.candidate};
        ...
        }, {"./lib/tojson": 22, "./lib/tosdp": 23}],
        17: [function (e, t) {
            var n = e("getusermedia"), o = {};
            t.exports = function (e, t) {
                var i, r = 2 === arguments.length, s = r ? t : e;
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), a >= 26 && c >= a)e = r && e || {
                        ...
                        o[u] = [s, r ? constraint : null], window.postMessage({type: "getScreen", id: u}, "*")
                    }
                }
        ...
        23: [function (e, t, n) {
            ...
            n.toSessionSDP = function (e, t, o) {
                var i = ["v=0", "o=- " + (t || e.sid || Date.now()) + " " + (o || Date.now()) + " IN IP4 0.0.0.0", "s=-", "t=0 0"], r = e.groups || [];
                ...
                var t = [], i = e.description, r = e.transport, s = i.payloads || [], a = r && r.fingerprints || [], c = [];
        ...
        16: [function (e, t) {
            ...
            var o = e("wildemitter"), i = window.webkitAudioContext || window.AudioContext, r = null;
            t.exports = function (e, t) {
                var s = new o;
                if (!i)return s;
                var t = t || {}, a = t.smoothing || .1, c = t.interval || 50, u = t.threshold, p = t.play, l = t.history || 10, h = !0;
                r || (r = new i);
                var f, d, m;
        ...
        22: [function (e, t, n) {
            ...
            n._setIdCounter = function (e) {
                ...
                var r = o.lines(e), s = o.lines(t), a = o.mline(r[0]), c = {
                    creator: i,
                    name: a.media,
                    description: {
                        descType: "rtp",
                ...
                "application" == a.media && (c.description = {descType: "datachannel"}, c.transport.sctp = []);
                var u = c.description, p = c.transport, l = o.findLine("a=mid:", r);
                ...
                b.forEach(function (e) {
                    var t = o.fingerprint(e), n = o.findLine("a=setup:", r, s);
                    n && (t.setup = n.substr(8)), p.fingerprints.push(t)
                });
                var w = o.findLine("a=ice-ufrag:", r, s), k = o.findLine("a=ice-pwd:", r, s);
                if (w && k) {
        ...
        24: [function (e, t, n) {
            n.lines = function (e) {
                ...
                for (var t = [], n = {}, o = 0; o < e.length; o++) {
                    ...
                    if (!n[r]) {
                        var s = {ssrc: r, parameters: []};
                        t.push(s), n[r] = s
                    }
                    i = i.join(" ").split(":");
                    var a = i.shift(), c = i.join(":") || null;
                    n[r].parameters.push({key: a, value: c})
                }
                return t
            }, n.groups = function (e) {
        ...
        21: [function (e, t) {
            ...
            var i = e("util"), r = e("webrtcsupport"), s = e("wildemitter");
        ...
        }, {util: 8, webrtcsupport: 10, wildemitter: 2}]
    }, {}, [1])(1)
});
var io = "undefined" == typeof module ? {} : module.exports;
!function () {
    !function (e, t) {
        ...
        e.SocketNamespace = n, t.util.mixin(n, t.EventEmitter), n.prototype.$emit = t.EventEmitter.prototype.emit, n.prototype.of = function () {
            ...
            var t = Array.prototype.slice.call(arguments, 1), n = t[t.length - 1], o = {type: "event", name: e};
            return "function" == typeof n && (o.id = ++this.ackPackets, o.ack = "data", this.acks[o.id] = n, t = t.slice(0, t.length - 1)), o.args = t, this.packet(o)
        }, n.prototype.disconnect = function () {
            return "" === this.name ? this.socket.disconnect() : (this.packet({type: "disconnect"}), this.$emit("disconnect")), this
        }, n.prototype.onPacket = function (e) {
